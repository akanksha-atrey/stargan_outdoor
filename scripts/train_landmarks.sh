...
python code/main.py --mode train --dataset RaFD --c_dim 7 --rafd_image_dir data/landmarks/train --sample_dir stargan_landmarks/samples --log_dir stargan_landmarks/logs --model_save_dir stargan_landmarks/models --result_dir stargan_landmarks/results
